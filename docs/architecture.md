...
| Calculator, Converter, Clock, Terminal, Browser | Browser only |  Correct — no server state to hold; Converter encryption/decryption is performed locally in the browser |
